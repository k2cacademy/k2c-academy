        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-border bg-card p-6">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Made your first online sale? Claim your official K2Ç Academy
              certificate — emailed to you instantly.
            </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-6">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Get <strong>250MB free data</strong> automatically sent to your
              phone on your birthday — every year, on us.
            </p>
            {profile?.birthday ? (
              ...
              <p className="mt-3 text-xs text-yellow-400">
                Add your birthday & network in your profile to unlock this.
              </p>
            )}
              ...
              <div className="mt-4 space-y-1.5">
                ...
                {giftsQ.data.slice(0, 3).map((g) => (
                  ...
                  >
                    ...
                    {new Date(g.sent_at).toLocaleDateString()} — {g.amount_mb}
                    MB ({g.status})
                  </div>
                ))}
              </div>
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Quick profile setup so we can send your birthday data gift and tag
          your wins.
        </p>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm({
                    ...form,
                    network: e.target.value as OnboardingData["network"],
                  })
                }
