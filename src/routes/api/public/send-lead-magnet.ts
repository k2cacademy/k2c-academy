        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #ffffff; padding: 32px; border-radius: 12px;">
            ...
            <p style="color: #cccccc; font-size: 16px; line-height: 1.6;">
              Your free guide — <strong style="color: #ffffff;">5 Things You Already Know That Can Earn You Money Online</strong> — is ready for you below. Read it today. Pick one skill. That is your starting point.
            </p>
            ...
            <div style="text-align: center; margin: 28px 0;">
              <a href="https://oniahemmanuel.systeme.io/da36229f" style="background: #FFD700; color: #000000; padding: 16px 32px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 16px; display: inline-block; letter-spacing: 0.5px;">
            ...
            <p style="color: #444444; font-size: 11px; text-align: center;">
              You received this because you requested the free guide at k2c-academy.lovable.app. No spam ever.
            </p>
          </div>
        `,
      }),
