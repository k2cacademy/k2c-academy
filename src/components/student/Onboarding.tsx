  ...
  return (
    <div className="min-h-screen bg-[#050505] relative overflow-hidden flex items-center justify-center px-4 py-10">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at top, rgba(147,51,234,0.3) 0%, rgba(91,33,182,0.1) 35%, transparent 70%)",
        }}
      />

      <div className="relative w-full max-w-xl">
        <div
          className="rounded-[28px] p-8 md:p-10 backdrop-blur-xl"
          style={{
            background: "linear-gradient(135deg, rgba(30,20,55,0.95) 0%, rgba(40,15,70,0.95) 100%)",
            border: "1px solid rgba(147,51,234,0.4)",
            boxShadow: "0 0 60px rgba(147,51,234,0.35)",
          }}
        >
          {step === 1 ? (
            <>
              <h1 className="text-3xl md:text-4xl font-bold text-white">
                You're in! Welcome to K2Ç Academy Student Portal! 🎉
              </h1>
              ...
              <button
                onClick={() => setStep(2)}
                className="mt-8 w-full py-4 rounded-2xl text-black font-bold text-lg flex items-center justify-center gap-2"
                style={{
                  background: "#FACC15",
            ...
            <>
              <h2 className="text-2xl md:text-3xl font-bold text-white">
                Before your coach greets you 💜
              </h2>
              <p className="mt-2 text-white/75 text-sm">
                Let us know who we're talking to — we also want to celebrate you on your birthday!
              </p>
